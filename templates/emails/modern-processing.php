...
<head>
    ...
    <style>
        ...
        .button { display: inline-block; background-color: #000000; color: #ffffff; padding: 14px 28px; text-decoration: none; border-radius: 6px; font-weight: 600; margin-top: 20px; text-align: center; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We're getting your order ready to be shipped. We will notify you with a tracking number as soon as it has been dispatched.</p>
